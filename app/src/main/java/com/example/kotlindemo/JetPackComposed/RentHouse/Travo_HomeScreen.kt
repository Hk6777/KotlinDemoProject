...
import com.example.kotlindemo.JetPackComposed.RentHouse.Retrofit.Address
import com.example.kotlindemo.JetPackComposed.RentHouse.Retrofit.Employment
import com.example.kotlindemo.JetPackComposed.RentHouse.Retrofit.UserResponce
...
fun Travo_HomeScreen() {
    ...
    var userList by remember { mutableStateOf<List<UserResponce>>(emptyList()) }
...
//                    // Navigate to detail page with selected user data
//                    DetailPage(user = selectedUser)
//                }
//            }
            items(userList) { user ->
                // Clickable item that navigates to detail page on click
                UserListItem(user = user) {
                    // Navigate to detail page with selected user data
//                    navController.navigate("detail")
//                    DetailPage(navController = navController, user = it)
                }
            }
        }
    }
...
@Composable
fun UserListItem(user: UserResponce, onItemSelected: (UserResponce) -> Unit) {
